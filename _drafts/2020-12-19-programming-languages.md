...
Of course these aren't the only imperative languages, but it's what I wanted to cover. You can also read [this post]({{< ref "blog/programming/2019-11-21-dynamic-vs-static.md" >}}) if you want to learn more about static vs dynamic typing.
